...
public class GenerateBill extends JFrame implements ActionListener {
    ...
    GenerateBill(String meter) {
        ...
        area.setText("\n\n\t---------Click on the---------\n\t Generate Bill Button to get\n\tthe bill for the Selected Month");
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (rs.next()) {
                ...
                area.append("\nCustomer information not found for meter number: " + meter + "\n");
            }
            ...
            if (rs.next()) {
                ...
                area.append("\nMeter information not found for meter number: " + meter + "\n");
            }
            ...
            if (rs.next()) {
                ...
                area.append("\nBill information not found for meter number: " + meter + " and month: " + month + "\n");
            }
