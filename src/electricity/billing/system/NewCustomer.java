...
public class NewCustomer extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            String query1 = "insert into customer (name, meter_no, address, city, state, email, phone) values('" + name + "', '" + meter + "', '" + address + "', '" + city + "', '" + state + "', '" + email + "', '" + phone + "')";
            String query2 = "insert into login (meter_no, username, password, user) values('" + meter + "', '" + name + "', '', '')";
